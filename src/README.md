# Web UI portfolio and apps docs

## What is this?

* knowledge base about [IT](https://stepanovv.ru/kbo) and [other](https://stepanovv.ru/kbb) engineering activities starting from the 2014
* my identity, contacts and code examples preview page.
* sample web apps. Old, but works.
...
* Production version at https://stepanovv.ru/portfolio/portfolio.html
...
```bash
curl --fail --compressed -q -L -s https://nodejs.org/dist/index.tab -o - || echo "use vpn"

cd ~/ &&\
git clone https://github.com/nvm-sh/nvm.git .nvm &&\
cd ~/.nvm &&\
git fetch origin v0.40.4 &&\
git checkout v0.40.4 && echo okokok
./nvm.sh
