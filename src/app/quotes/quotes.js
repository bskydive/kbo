...
const quotes = [
	['Программисты', '#',
		...
		'Каждый день делай простое, понятное, короткое действие, помогающее расти и побеждать',
		...
		'проект перманентно в огне и дерьме',
		...
		'Жадный алгоритм в действии: выгодно делать то, что приносит прибыль здесь и сейчас. Платить за то, что сложно посчитать или долго ждать не принято',
	],
