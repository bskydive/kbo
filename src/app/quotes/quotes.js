...
const quotes = [
	['Программисты', '#',
		...
		'Показ проходит так: все чинно рассаживаются вокруг стола, тимлид достаёт ноутбук, начинает всех удивлять и оправдываться',
		...
		'синканёмся на дейлике, заассайним ишью и поправим энвы бэке, т.е.: заслушаем доклады и нарежем задачи на утренней линейке, а потом тыловики вкрячат переменные окружения',
		'мы бежим впереди машиниста, который бежит впереди паровоза, чтобы показать куда ехать',
		'https://www.youtube.com/watch?v=u-ZREh7geL8 Zimtstern Leaves Spot - TransWorld SNOWboarding >Прощай, осень<',
