...
const quotes = [
	['Программисты', '#',
		'В женской общаге посуду моют после еды, в мужской - перед. Женский рефакторинг происходит после релиза в плановом порядке, мужской - до релиза, в авральном. Рефакторинг - это не вопрос эффективности, это про чистоту и гигиену. Как часто вы наводите порядок у себя дома или на рабочем месте? Порядок не нужно наводить только там, где ничего не происходит.',
	...
	['Иоганн Вольфганг Гёте', 'https://greatwords.org/authors/659/',
