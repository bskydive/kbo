...
const quotes = [
	[
		"Айтишники",
		"#",
		"Бизнесу не нужны ваши идеи, ему нужны деньги на кармане. Таким образом он готовит кадровый резерв. Потому что если паровозик смог сам, то зачем ему машинист?",
