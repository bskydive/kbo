...
```
1. Для вложенных типов данных предпочтительнее использовать объекты вместо массивов, т.к. внутрь можно вложить дпополнительные свойства, например, isExpanded. Вложенные списки лучше делать массивами, т.к. *ngFor не умеет итерировать объекты.
