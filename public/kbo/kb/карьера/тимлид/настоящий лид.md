 ...
 * netology
	...
	* Модуль 1. Погружение в профессию
		• Определяемся с бизнес-целью своего продукта
		• Заполняем Паспорт компетенций
	* Модуль 2. Основы продуктовой методологии: Lean подход и Customer development
		• Создаём наработки по Customer development по своему продукту
		• Учимся строить CJM
	* Модуль 3. Управление продуктом на основе финансовых показателей
		• Добавляем юнит-экономику и P&L
	* Модуль 4. Продуктовая аналитика
		• Создаём наработки по модулю аналитики по своему продукту
		• Читаем дополнительные материалы
		• Задаём вопросы ментору в чате или участвуем в групповой менторской сессии по дипломам
	*
