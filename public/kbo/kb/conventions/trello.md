...
| № | ФИО | роль, чем может помочь | город | время MSK+X | рабочее время MSK | на связи MSK | skype(резервная связь) | тел(экстренная связь) | gmail(для сервисов/календарей) | примечание |
| --- | --- 				| --- 		| --- 			| --- | --- | --- | --- 			| --- 			| --- 						| --- 	|
